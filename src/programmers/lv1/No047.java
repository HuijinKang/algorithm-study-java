...
/**
 ...
 즉 프로그램 시작 이후 초기에 k일까지는 모든 출연 가수의 점수가 명예의 전당에 오르게 됩니다. k일 다음부터는 출연 가수의 점수가 기존의 명예의 전당 목록의
 ...
 [10, 100, 20, 150, 1, 100, 200]이라면, 명예의 전당에서 발표된 점수는 아래의 그림과 같이 [10, 10, 10, 20, 20, 100, 100]입니다.
...
public class No047 {
    public int[] solution(int k, int[] score) {
        ...
        Queue<Integer> priorityQueue = new PriorityQueue(); //일반적인 큐는 먼저 들어간 데이터가 먼저 나가는 구조인 FIFO 형식의 자료구조입니다. 반면에 우선순위 큐의 경우 들어가는 순서와는 상관없이 우선순위가 높은 데이터가 먼저 나가는 자료구조입니다.
    ...
    public static void main(String[] args) {
        No047 no047 = new No047();
        int[] score = {10, 100, 20, 150, 1, 100, 200};
        System.out.println(Arrays.toString(no047.solution(3, score)));
    }
}
