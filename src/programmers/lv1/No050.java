...
/**
 ...
 각 폰켓몬의 종류 번호가 [3번, 1번, 2번, 3번]이라면 이는 3번 폰켓몬 두 마리, 1번 폰켓몬 한 마리, 2번 폰켓몬 한 마리가 있음을 나타냅니다. 이때,
...
public class No050 {
    public int solution(int[] nums) {
        int answer = 0;
        int ponketmonCount = nums.length;

        answer = ponketmonCount/2;

        Integer[] numsIntegerArray = Arrays.stream(nums).boxed().toArray(Integer[]::new);

        Set<Integer> set = new HashSet<>(Arrays.asList(numsIntegerArray));
