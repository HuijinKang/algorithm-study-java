...
public class No043 {
    public String[] solution(int n, int[] arr1, int[] arr2) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            for (int j = 0; j < n; j++) {
                if (map[i][j].equals(" ") && Character.toString(binaryString.charAt(j)).equals("#")) {
                    map[i][j] = Character.toString(binaryString.charAt(j));
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(no043.solution(n,arr1,arr2)));
    }
}
