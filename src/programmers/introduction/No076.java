...
public class No076 {
    public int[] solution(String[] keyinput, int[] board) {
        int[] answer = {0, 0};
        int boardX = (int) Math.floor(board[0]/2);
        int boardY = (int) Math.floor(board[1]/2);
    ...
    public static void main(String[] args) {
        No076 no076 = new No076();
        String[] keyinput = {"down", "down", "down", "down", "down", "up"};
        int[] board = {7, 9};

        System.out.println(Arrays.toString(no076.solution(keyinput, board)));
    }
}
